...
export function Profile() {
  ...
  useEffect(() => {
    ...
    const savedCurrency = localStorage.getItem("qfin_currency");
    if (savedCurrency) {
      setCurrency(savedCurrency);
    }
    const savedTheme = localStorage.getItem("qfin_theme");
    if (savedTheme) {
      setTheme(savedTheme);
    }
  }, []);
            ...
            <CardContent>
              {isEditing ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                    <div>
                      <p className="text-sm text-gray-600">Moeda Preferencial</p>
                      <Select value={currency} onValueChange={(value) => {
                        setCurrency(value);
                        localStorage.setItem("qfin_currency", value);
                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                    <div>
                      ...
                      <Select value={theme} onValueChange={(value) => {
                        setTheme(value);
                        localStorage.setItem("qfin_theme", value);
