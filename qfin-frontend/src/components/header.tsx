import { DollarSign, Menu, User, LogOut, Settings, HelpCircle, Bell, List } from "lucide-react";
      ...
      <div className="flex h-16 items-center justify-between px-6">
        ...
        <nav className="hidden md:flex items-center gap-2">
          ...
          <Button 
            ...
            className="hover:bg-blue-50"
            style={{ 
              color: isActive("/budgets") ? "#1E3A8A" : "#6B7280",
          ...
          <Button 
            ...
            className="hover:bg-blue-50"
            style={{ 
              color: isActive("/calculators") ? "#1E3A8A" : "#6B7280",
              fontWeight: isActive("/calculators") ? "600" : "400"
            }}
