...
public class Goal {
    ...
    private Double alertThreshold; // Optional: percentage to trigger an alert (e.g., 80%)
    ...
    public Goal(String name, Double targetAmount, Double currentAmount, LocalDate deadline, String category, String description, Double alertThreshold, User user) {
        this.name = name;
