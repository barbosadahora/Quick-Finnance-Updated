...
public class CategoryService {
    ...
    // Update a category
    @Transactional
    public Category updateCategory(Long userId, Long categoryId, String name, Long parentId, String color, String icon, String notes) {
    ...
    public List<Category> searchCategories(Long userId, String searchTerm) {
        return categoryRepository.findByUserIdAndNameContainingIgnoreCaseOrUserIdAndNotesContainingIgnoreCase(userId, searchTerm, userId, searchTerm);
    }

    public List<Category> filterCategoriesByType(Long userId, Category.CategoryType type) {
        return categoryRepository.findByUserIdAndType(userId, type);
    }

    public List<Category> filterCategoriesByNotesPresence(Long userId, boolean hasNotes) {
        if (hasNotes) {
            return categoryRepository.findByUserIdAndNotesIsNotNull(userId);
        } else {
            return categoryRepository.findByUserIdAndNotesIsNull(userId);
        }
    }

    public List<Category> filterCategoriesByDefault(Long userId, boolean isDefault) {
        return categoryRepository.findByUserIdAndIsDefault(userId, isDefault);
    }
